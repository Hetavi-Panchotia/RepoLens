...
export default function SpotlightCard({ children, className = '', ...rest }) {
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden rounded-2xl border border-white/10 bg-slate-900 shadow-sm transition-all duration-300 hover:shadow-brand-500/10 ${className}`}
      {...rest}
    >
      <div
